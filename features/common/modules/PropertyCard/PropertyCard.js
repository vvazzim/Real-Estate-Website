...
<Box marginBottom="4rem" backgroundColor="#fff">
 ...
 <Box backgroundImage={`url("${coverPhoto}")`} height ="250px" backgroundPosition="center"
...
<Badge colorScheme="green" > {purpose}
...
marginBottom="1rem">
    ...
    isTruncated
     >{address}</Text>
<Text isTruncated>{title}
</Text>
<HStack spacing="1.3rem" marginTop="1rem" >
    <Flex alignItems="center" gap="0.3rem">{rooms}
    <TbBed></TbBed>
    </Flex>
    <Flex alignItems="center" gap="0.3rem">{baths}
    <TbBath></TbBath>
    </Flex>
    <Flex alignItems="center" gap="0.3rem">{sqSize}
    <sup>m²</sup>
    <TbRuler></TbRuler>
    </Flex>
